...
const identityFields: FieldConfig[] = [
  { key: "plantPart", label: "Plant Part(s)", description: "Main anatomical parts of the plant", type: "multiselect", options: ["Roots","Rhizomes","Bulbs","Tubers","Stems","Leaves","Flowers","Fruits","Spores"] },
