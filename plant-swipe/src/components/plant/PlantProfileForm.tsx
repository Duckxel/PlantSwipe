...
// Option arrays available for form rendering if needed
const _utilityOptions = ["edible","ornamental","aromatic","medicinal","fragrant","cereal","spice"] as const
const _plantTypeOptions = ["tree","shrub","small_shrub","fruit_tree","bamboo","cactus_succulent","herbaceous","palm","fruit_plant","aromatic_plant","medicinal_plant","climbing_plant","vegetable_plant","perennial_plant","bulb_plant","rhizome_plant","indoor_plant","fern","moss_lichen","aquatic_semi_aquatic"] as const
void _utilityOptions; void _plantTypeOptions
