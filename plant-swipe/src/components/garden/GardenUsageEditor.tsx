        ...
        {USAGE_OPTIONS.map((opt) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-3 rounded-2xl border-2 p-4 text-sm font-medium transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 ${
                active
