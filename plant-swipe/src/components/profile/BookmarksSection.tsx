          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5">
            ...
            {isOwner && bookmarks.length === 0 && (
              <button 
                ...
                className="aspect-square rounded-2xl border-2 border-dashed border-stone-200 dark:border-[#3e3e42] flex flex-col items-center justify-center text-stone-400 hover:text-emerald-600 hover:border-emerald-300 dark:hover:text-emerald-400 dark:hover:border-emerald-700 transition-all bg-gradient-to-br from-stone-50 to-white dark:from-stone-900 dark:to-stone-800 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"
              >
