...
export const FriendsPage: React.FC = () => {
    ...
    <section className="relative overflow-hidden rounded-[32px] border border-stone-200 dark:border-[#3e3e42] bg-gradient-to-br from-emerald-50 via-white to-stone-100 dark:from-[#252526] dark:via-[#1e1e1e] dark:to-[#171717]">
      ...
      <div className="relative space-y-6 p-8 md:p-12">
        <Badge className="inline-flex items-center gap-2 rounded-2xl px-4 py-1 bg-white/70 dark:bg-[#2d2d30]/70 backdrop-blur">
          ...
          {t("friends.hero.badge")}
        </Badge>
        <h1 className="text-3xl md:text-4xl font-semibold tracking-tight">
          {t("friends.hero.title")}
        </h1>
  ...
  if (!user) {
    return (
      <div className="max-w-6xl mx-auto px-4 md:px-0 pb-16 space-y-8">
        {heroSection}
        <section
          className={`${cardBaseClass} px-6 md:px-10 py-10 text-center shadow-sm`}
        >
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-0 pb-16 space-y-8">
      {heroSection}
      <section
        className={`${cardBaseClass} px-4 md:px-8 py-6 md:py-8 shadow-sm`}
      >
        <div
        ...
        >
          ...
          {pendingRequests.length > 0 && (
            <Card
              className={`${cardBaseClass} w-full lg:w-[300px] lg:flex-shrink-0 order-1 lg:order-1 h-full`}
            >
          ...
          <Card className={`${cardBaseClass} w-full order-2 lg:order-2 h-full`}>
          ...
          {sentPendingRequests.length > 0 && (
            <Card
              className={`${cardBaseClass} w-full lg:w-[300px] lg:flex-shrink-0 order-3 lg:order-3 h-full`}
            >
              <CardContent className="p-6 md:p-8 space-y-4 h-full flex flex-col">
                <div className="text-xl font-semibold text-black dark:text-white">
