...
export function AuthPage({ mode: initialMode = "login" }: AuthPageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-stone-100 to-stone-200 dark:from-[#252526] dark:to-[#1e1e1e] px-4 py-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-stone-500 dark:text-stone-400">
            {isSignup
              ...
              : t("auth.loginDescription", "Welcome back")}
          </p>
        </div>

        {/* Auth Form */}
        <div
          className="space-y-3 bg-white dark:bg-[#2d2d30] rounded-2xl border border-stone-200 dark:border-[#3e3e42] p-6 shadow-sm"
        ...
        >
          ...
          {isSignup && (
            <div className="mt-2 space-y-3">
              <div className="flex items-start gap-3 rounded-2xl border border-stone-200 dark:border-[#3e3e42] bg-stone-50 dark:bg-[#1e1e1e] p-3">
                <input
                ...
                <Label
                  ...
                  className="text-sm leading-5 text-stone-600 dark:text-stone-200"
                >
          ...
          <div className="pt-2 space-y-3">
            ...
            <div className="text-center text-sm">
              {isSignup ? (
                <button
                  className="underline text-stone-600 dark:text-stone-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors"
                  onClick={() => {
                    setMode("login")
                    setError(null)
                  }}
