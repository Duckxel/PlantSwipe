              ...
              >
                ...
                <Card className="relative h-full w-full overflow-hidden bg-black text-white shadow-2xl rounded-[24px] border border-white/20 dark:border-white/10">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 z-20 p-5 pb-6 text-white">
                    ...
                    <h2 className="text-2xl font-semibold tracking-tight drop-shadow-sm">
                      {current.name}
                      {current.variety && (
                        <span className="ml-2 inline-block bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent text-xl font-extrabold tracking-tight drop-shadow-sm">
                          &lsquo;{current.variety}&rsquo;
                        </span>
                      )}
                    </h2>
                    ...
                    {/* Action bar - all key actions in the thumb zone */}
                    <div
                    ...
                    >
                      ...
                      <button
                        ...
                        className="h-12 w-12 rounded-full flex items-center justify-center bg-white/20 backdrop-blur-sm border border-white/25 text-white active:scale-90 transition-all shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"
                        aria-label={t("plant.next")}
                      ...
                      {/* Info button - primary CTA */}
                      <button
                        type="button"
                        className="rounded-2xl h-12 px-8 bg-white/95 text-black active:scale-95 flex items-center justify-center gap-1.5 shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 font-medium"
                      ...
                      <button
                        ...
                        aria-label={liked ? "Unlike" : "Like"}
                        className={`h-12 w-12 rounded-full flex items-center justify-center shadow-lg border-2 transition-all duration-150 active:scale-90 cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 ${
                          liked ? "bg-rose-600 text-white border-rose-500" : "bg-white/20 backdrop-blur-sm text-white border-white/25"
                        }`}
                        style={{ touchAction: 'manipulation', WebkitTapHighlightColor: 'transparent' }}
                      >
                        <Heart className={`h-6 w-6 ${liked ? "fill-current" : ""}`} />
