...
export default function PrivacyPage() {
  ...
  const seoTitle = t("seo.privacy.title", { defaultValue: "Aphylia Privacy Policy" })
  const seoDescription = t("seo.privacy.description", {
    defaultValue: "Read the Aphylia Privacy Policy to understand how we collect, use, and protect your personal data.",
  })
    ...
    <div className="max-w-4xl mx-auto mt-8 px-4 pb-20 space-y-10">
      <section className="rounded-[28px] border border-stone-200 dark:border-[#3e3e42] bg-white dark:bg-[#1f1f1f] p-8 md:p-12 space-y-4 shadow-sm shadow-emerald-500/5">
        <Badge className="rounded-2xl px-4 py-1 w-fit bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-200">
          {t("privacyPage.hero.eyebrow", { defaultValue: "Your privacy matters" })}
        </Badge>
        <h1 className="text-3xl font-semibold">
          {t("privacyPage.hero.title", { defaultValue: "Privacy Policy" })}
        </h1>
        <p className="text-base text-stone-600 dark:text-stone-300 max-w-2xl">
          {t("privacyPage.hero.subtitle", {
            defaultValue: "Learn how Aphylia collects, uses, and protects your personal information. Your privacy is important to us.",
          })}
        </p>
      ...
      <section className="rounded-3xl border border-dashed border-stone-300 dark:border-[#3e3e42] px-8 py-6 bg-stone-50/70 dark:bg-[#1f1f1f] flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h3 className="text-xl font-semibold">{t("privacyPage.contact.title", { defaultValue: "Questions about your privacy?" })}</h3>
          <p className="text-sm text-stone-600 dark:text-stone-400 max-w-xl">
            {t("privacyPage.contact.subtitle", { defaultValue: "Contact us via the Contact page or email us at privacy@aphylia.app. We're here to help with any data-related concerns." })}
          </p>
        </div>
