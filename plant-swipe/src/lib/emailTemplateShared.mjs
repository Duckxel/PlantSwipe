/**
 * Auto-generated JS version of emailTemplateShared.ts for Node.js (server.js).
 * DO NOT EDIT THIS FILE DIRECTLY — edit emailTemplateShared.ts instead,
 * then run: npm run sync-email-template
 *
 * This file exists because server.js runs on Node.js v20 which cannot
 * import .ts files directly. The Supabase Edge Function (Deno) and the
 * Vite frontend both consume the .ts version.
 */
...
export const EMAIL_WRAPPER_I18N = {
  en: {
 ...
 */
export function getEmailWrapperStrings(language = 'en') {
 ...
 */
export function getLogoImgLarge() {
 ...
 */
export function wrapEmailHtmlShared(bodyHtml, options = {}) {
