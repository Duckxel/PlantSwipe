// Auto-generated JS version of emailTemplateShared.ts — DO NOT EDIT THIS FILE DIRECTLY
// Run: npm run sync-email-template
...
<head>
  ...
  <style>
    table, td, div, p, a { font-family, sans-serif; }
  </style>
  <![endif]-->
  <style>
    /* Reset */
 ...
 */
export function wrapAdminEmailHtmlShared(bodyHtml, options = {}) {
  const currentYear = new Date().getFullYear()
