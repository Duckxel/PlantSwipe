...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS notification_time TEXT DEFAULT '10h'
  CHECK (notification_time IS NULL OR notification_time IN ('6h', '10h', '14h', '17h'));
