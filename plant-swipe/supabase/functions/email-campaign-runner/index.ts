...
const _EMAIL_WRAPPER_STRINGS: Record<SupportedLanguage, {
  teamName: string
  tagline: string
 ...
 */
function _findMatchingDivClose(html: string, startPos: number): number {
  let depth = 0
  let pos = startPos
...
// The wrapEmailHtml function has been replaced by wrapEmailHtmlShared from the shared module
// Edit src/lib/emailTemplateShared.ts and run: npm run sync-email-template
